...
public class AwesomeParallelFirewall {
	...
	public static void main(String[] args) {
	    ...
	    ConcurrentHashMap<Integer, SkipList> rTable = new ConcurrentHashMap <Integer, SkipList>();
	    ...
	    AwesomeParallelPacketWorker[] workersData = new AwesomeParallelPacketWorker[n];
	    for(int i=0; i< n;i++){
	    	workersData[i] = new AwesomeParallelPacketWorker(done, queues, rTable, pngTable, histogram, tableLock);
